...
\begin{body}
	...
	\begin{tabular}{@{}l l l l l l}
		...
		\hspace{0.5cm}Python & {\color{red}\faStar\faStar\faStar}\hspace{1.4cm}		& \hspace{0.5cm}d3.js & {\color{red}\faStar\faStar}\hspace{1.6cm}			& \hspace{0.5cm}XGBoost & {\color{red}\faStar\faStar\faStar}
	\end{tabular}
...
\begin{body}
	...
	\textbf{Preferred Stack:} SQL, R::dplyr, R::ggplot2,  R::Shiny, R::lme4, d3.js\\
	\medskip
